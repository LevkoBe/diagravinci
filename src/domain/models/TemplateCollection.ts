...
export const DIAGRAVINCI_COLLECTION_ID = "__diagravinci__";
export const DIAGRAVINCI_COLLECTION: TemplateCollection = {
  id: DIAGRAVINCI_COLLECTION_ID,
  name: "DigraVinci",
  isBuiltIn: true,
  templates: DIAGRAVINCI_TEMPLATES,
};
